...
В **Настройки → Будильник слов**:

1. Включите будильник и задайте интервал (по умолчанию 3 часа).
2. Каждые X часов приходит уведомление со случайным коротким словом (до трёх в баннере).
3. Нажатие открывает мини-окно с переводом — можно повторить карточки и перейти в основное приложение.
4. Чтобы будильник снова запустился, нужно пройти N карточек (настраивается).
